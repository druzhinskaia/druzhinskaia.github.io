...
def build() -> None:
    ...
    story.append(bullet("<b>Дек 2025 - апр 2026 · Ведущий аналитик, ГАУ ИТЦ \"Соцзащита\" Москвы.</b> Официальная должность; руководства командой не предполагала. Автоматизация отчетности, контроль качества данных и работа с выгрузками из 1C.", base))
    story.append(bullet("<b>Янв 2022 - фев 2026 · Администратор, ИП Дружинская.</b> Фактический фокус: ведение и проверка операционных данных, подготовка отчетности, структурирование документов и координация процессов. Официальное трудоустройство: февраль 2025 — февраль 2026.", base))
