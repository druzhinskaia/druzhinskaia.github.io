...
Материалы основаны на коммерческой аналитической задаче. Для публикации обезличены наименования, роли и отдельные показатели; сохранены структура процесса, логика требований и состав артефактов.
...
| 08.04-12.04 | Анализ | сбор входных требований, анализ проблем и первопричин | Выполнено |
...
| Анализ процесса | сбор входных требований, AS-IS описание, проблемы, первопричины, TO-BE описание |
