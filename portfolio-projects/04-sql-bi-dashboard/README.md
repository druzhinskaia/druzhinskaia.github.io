...
Материалы основаны на коммерческой задаче по контролю продаж, маржинальности и дебиторской задолженности. Для публикации набор данных, наименования и отдельные показатели обезличены и реконструированы; сохранены модель данных, SQL-логика, метрики и сценарий дашборда.
