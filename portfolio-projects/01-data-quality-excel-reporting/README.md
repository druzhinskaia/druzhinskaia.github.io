...
Материалы подготовлены на основе коммерческой задачи. Для публикации выгрузки и показатели обезличены и реконструированы; логика проверок, структура отчета и подход к контролю качества сохранены.
...
- Обезличенные демонстрационные выгрузки по заказам, клиентам и оплатам.
...
- Подготовлены 3 обезличенные демонстрационные выгрузки: `orders_raw.xlsx`, `clients_raw.xlsx`, `payments_raw.xlsx`.
...
- `data/raw` - обезличенные демонстрационные выгрузки.
...
Подготовила аналитический кейс по контролю качества данных из 1С и регулярной отчетности в Excel. На основе обезличенных демонстрационных выгрузок по заказам, клиентам и оплатам настроила формульные проверки дублей, пропусков, некорректных сумм, статусов и связей между таблицами, собрала реестр ошибок, сводную аналитику, дашборд и план исправлений для руководителя.
